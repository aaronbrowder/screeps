...
function generateHarvesterBody(desiredWorkParts, spawnRoom, assignedRoomName) {
...
exports.generateHarvesterBody = generateHarvesterBody;
function generateTransporterBody(desiredCarryParts, spawnRoom, assignedRoomName) {
    const doClaim = rooms.getDoClaim(assignedRoomName);
...
exports.generateTransporterBody = generateTransporterBody;
function generateBuilderBody(desiredWorkParts, spawnRoom, assignedRoomName) {
    const doClaim = rooms.getDoClaim(assignedRoomName);
...
exports.generateBuilderBody = generateBuilderBody;
