...
function run(creep) {
    ...
    function goToRampart() {
        ...
        if (unoccupiedRamparts.length) {
            const rampartsNearHostiles = _.filter(unoccupiedRamparts, o => o.pos.findClosestByRange(hostiles).pos.isNearTo(o.pos));
...
exports.run = run;
//# sourceMappingURL=role.mercenary.js.map